...
class TaskViewModel(app: Application) : AndroidViewModel(app) {
    ...
    companion object {
        ...
        private val defaultOrchardTasks = listOf(
            // Janvier
            GardenTask(month=1, title="🍎 Taille d'hiver pommiers/poiriers hors gel.", isDefault=true),
            ...
            GardenTask(month=2, title="🫐 Tailler mûriers, framboisiers, cassis et groseilliers.", isDefault=true),
            // Mars
            GardenTask(month=3, title="🍎 Terminer la taille avant l'ouverture des bourgeons.", isDefault=true),
            GardenTask(month=3, title="🍎 Apporter engrais au pied des arbres (fumier mûr, compost : 1 kg/m² maximum, cendres).", isDefault=true),
            ...
            GardenTask(month=4, title="Rouille grillagée : traitement préventif (bouillie bordelaise, purin de prêle) après floraison et tous les 15 jours par température < 25°.", isDefault=true),
            GardenTask(month=4, title="🍓 Protéger fraisiers avec filet anti-oiseaux dès la floraison.", isDefault=true),
            // Mai
            GardenTask(month=5, title="🍎 Palissage des pousses des jeunes fruitiers.", isDefault=true),
            GardenTask(month=5, title="🍎 Apporter engrais riche en potasse (cendres de bois).", isDefault=true),
            GardenTask(month=5, title="Carpocapse : poser pièges à phéromones.", isDefault=true),
            GardenTask(month=5, title="Rouille grillagée : poursuivre les traitements préventifs, traitement curatif à la bouillie bordelaise.", isDefault=true),
            GardenTask(month=5, title="🍎 Pas de taille en vert avant le 15 juin.", isDefault=true),
            // Juin
            GardenTask(month=6, title="🍎 Taille en vert à partir du 20-21 juin.", isDefault=true),
            GardenTask(month=6, title="🍎 Éclaircir les fruits sur arbres trop chargés.", isDefault=true),
            GardenTask(month=6, title="Carpocapse : vérifier et renouveler pièges à phéromones.", isDefault=true),
            ...
            // Juillet
            GardenTask(month=7, title="🍎 Taille en vert légère.", isDefault=true),
            GardenTask(month=7, title="🍎 Arroser jeunes arbres tôt le matin ou en soirée (15-20 L/m² par semaine si sécheresse).", isDefault=true),
            GardenTask(month=7, title="🍎 Poser paillage pour conserver l'humidité.", isDefault=true),
            GardenTask(month=7, title="🍎 Éclaircir les pommes (améliore calibre et qualité).", isDefault=true),
            GardenTask(month=7, title="Carpocapse : vérifier pièges, détruire les fruits véreux tombés au sol, poser des bandes de carton ondulé autour du tronc pour piéger les chenilles.", isDefault=true),
            GardenTask(month=7, title="Rouille grillagée : poursuivre les traitements préventifs, traitement curatif à la bouillie bordelaise.", isDefault=true),
            // Août
            GardenTask(month=8, title="🍎 Poursuivre l'arrosage des jeunes arbres.", isDefault=true),
            ...
            GardenTask(month=8, title="Carpocapse : 2e vague du papillon. Poursuivre le piégeage, la destruction des fruits, la pose de carton ondulé.", isDefault=true),
            // Septembre
            ...
            GardenTask(month=9, title="Carpocapse : poursuivre le piégeage, la destruction des fruits, la pose de carton ondulé.", isDefault=true),
            GardenTask(month=9, title="Rouille grillagée : ramasser et détruire les feuilles infectées tombées au sol.", isDefault=true),
            // Octobre
            GardenTask(month=10, title="🍎 Stocker fruits à 10°C max, hygrométrie 70-80%.", isDefault=true),
            GardenTask(month=10, title="🍎 Nettoyer arbres : couper branches mortes, malades, croisées. Brosser et passer le tronc et les charpentières au blanc arboricole.", isDefault=true),
            GardenTask(month=10, title="🫐 Bouturer groseilliers, cassis, framboisiers.", isDefault=true),
            GardenTask(month=10, title="Carpocapse : retirer et détruire les bandes de carton ondulé.", isDefault=true),
            GardenTask(month=10, title="Rouille grillagée : ramasser et détruire les feuilles infectées tombées au sol.", isDefault=true),
            // Novembre
            GardenTask(month=11, title="🍎 Apporter engrais de fond (compost, fumier mûr, 1 kg/m² max sur les petits fruits et éventuellement arbres fruitiers).", isDefault=true),
